...
# VIDEO 1 Grammar of Graphics {greenscreen} ~ 7 min
<!-- ## Welcome -->
...
Run this and take a moment to appreciate the result. Very informative, isn't it?
...
Histograms are perfect for exploring the distribution of a single variable. Let’s start with life expectancy. Create a histogram and observe the shape of the distribution. 
...
Pause the video and try it yourself! How many peaks—or modes—does it have? Play around with the `bins` parameter. Adjusting the number of bins changes the granularity of your histogram, which can affect how you interpret the distribution. What value of bins seems reasonable to you?
