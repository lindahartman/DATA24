...
contain so many columns that methods like `.head()` or `.describe()` don’t provide a clear overview. In such cases, Polars offers a particularly useful method: `.glimpse()`.
