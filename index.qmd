...
# VIDEO 2 Shell {studio} LINDA ~ 7 min
...
# VIDEO 3 Navigation {studio} DMYTRO ~ 6 min
...
This means my terminal has opened in my user directory. That’s the folder where my personal files are stored.
...
# VIDEO 4 uv {studio} DMYTRO ~ 3 min
...
# VIDEO 5 Python {studio} DMYTRO ~ 10 min
...
# VIDEO 6 Jupyter {studio} DMYTRO ~ 12 min
<!-- ## Launch Jupyter -->
...
Press Ctrl-Enter (or Cmd-Enter on a Mac) to execute the code. You’ll see the output — today’s date — appear below the cell. 
...
Now, let's get comfortable navigating a Jupyter Notebook. One of the first things you'll need to master is switching between edit mode and command mode—and trust me, this will become second nature in no time!
...
- To enter: **click** or hit **Enter**
- To exit: **click** outside or hit **Esc**
::: 
-->
...
- To create a heading, start a line with `#` sign. The more `#` symbols you use, the smaller the heading.
- To make text italic, wrap it in single stars.
